            ...
            <div className="min-h-screen bg-gradient-to-br from-primary-600 via-primary-700 to-blue-600 flex items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="game-container w-full max-w-md relative z-10 animate-game-start">
                    ...
                    <div className="mt-12 text-center">
                        <div className="text-sm text-gray-500 mb-3">Created by Priyas Ojha</div>
                        <div className="flex justify-center space-x-4">
                            <a
                                href="https://www.linkedin.com/in/priyasoj/"
                                target="_blank"
                            ...
                            >
                                ...
                                <span className="text-sm font-medium">priyasoj</span>
                            </a>
                            <a
                                href="https://github.com/priyas-09"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            >
                                ...
                                <span className="text-sm font-medium">priyas-09</span>
                            </a>
                        </div>
                    </div>
                </div>
